...
export const LEVEL_CONFIGS: Record<Difficulty, LevelConfig> = {
  [Difficulty.BEGINNER]: { maxNumber: 5, operations: ['+'] },
  [Difficulty.EASY]: { maxNumber: 10, operations: ['+', '-'] },
  [Difficulty.MEDIUM]: { maxNumber: 15, operations: ['+', '-'] },
  [Difficulty.HARD]: { maxNumber: 20, operations: ['+', '-', '*'] },
  [Difficulty.EXPERT]: { maxNumber: 30, operations: ['+', '-', '*', '/'] }
};
